...
export default function ArticleCard({ article }: { article: Article }) {
  return (
    ...
    >
      <div className="h-40 bg-gradient-to-br from-[var(--color-beige)] to-[var(--color-beige-dark)] flex items-center justify-center">
        <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="var(--color-wood-dark)" strokeWidth="1.5">
